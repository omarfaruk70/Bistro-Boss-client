  ...
  const li = (
    <>
      ...
      <li className="hover:border-b-2 py-3 rounded-sm transition-all border-yellow-500">
        <NavLink
          className={({ isActive, isPending }) =>
            isPending ? "" : isActive ? "text-white bg-amber-400 font-bold" : ""
          }
          to={"/menu"}
        >
          Menus
      ...
      <div className="  text-white navbar px-2 md:px-5 h-[80px] lg:px-10 border-b-2">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-sm flex justify-start items-start dropdown-content mt-3 z-[1] px-5 shadow bg-slate-50 rounded-box w-40"
            >
              {li}
            </ul>
          </div>
        ...
        <div className="navbar-end">
          <div className="flex justify-center items-center">
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul
                tabIndex={0}
                className="flex flex-col text-slate-600 justify-center z-[99] px-4 py-5 bg-slate-50 items-start font-semibold gap-y-5 menu menu-sm dropdown-content mt-3  p-2 shadow rounded-box w-40"
              >
